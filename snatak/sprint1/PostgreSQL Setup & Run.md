...
| ------------ | ---------- | ------- | --------------- | -------------- | ------------ | ----------- | ----------- | ----------- |
| Mukesh Kharb | 26/04/2026 | 1.0     | Mukesh Kharb    | 26/04/2026     | Team         | -           | -           | -           |
...
> PostgreSQL is used as the primary relational database for the Attendance microservice in this POC.
...
As per project structure, PostgreSQL is used only by attendance-api. fileciteturn4file1

---

## Prerequisites

* Ubuntu 22.04 (EC2 or local VM)
* sudo access
...
This configuration is already defined in project files. fileciteturn4file15
...
Project uses Poetry for dependency management. fileciteturn4file16
